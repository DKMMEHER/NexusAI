...
const AdvancedSettings = ({ settings, setSettings, showModel = false }) => {
    ...
    return (
        <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-4 border border-slate-100 dark:border-slate-700 mb-6 transition-colors duration-200">
            <div className="flex items-center gap-2 mb-4 text-slate-700 dark:text-slate-200 font-medium">
                <Settings2 size={18} />
